    ...
    return (
        <div className="home-hero-auction lg:min-h-[21.875rem]">
            ...
            <div className="flex items-center !mt-6">
                <IconLock/>
                <p className="text-px18 font-500 ml-1.5">Ended on <span className="font-700 text-gray-3">{dayjs(props.auction?.endTime.toNumber() * 1000).format('h:mmA, MMMM D, YYYY')}</span></p>
            </div>
            <div className="flex items-center mt-3">
                <IconHeart/>
                <div className="text-px18 font-500 ml-1.5">Won by <SimpleAddress
                    address="0x497F34f8A6EaB10652f846fD82201938e58d72E0"
            ...
            <div className="flex space-x-4 !mt-8">
                {isSettled ? (<>
                    <Button className="text-px18 leading-px26 basic default !h-11" onClick={() => setBidModalOpen(true)}><IconBidHistory className="mr-2.5"/> Bid history</Button>
                    <a href={buildEtherscanAddressLink('0x0000000000000000000000000000000000000000 ')} target="_blank" rel="noreferrer">
                        <Button className="text-px18 leading-px26 basic default !h-11"><IconVerified className="mr-2.5"/> Etherscan</Button>
                    </a>
                </>) : (<>
                    <Button
